"""
Module: wordCount.py
This script reads a file containing words, identifies distinct words, and calculates their frequencies
using basic algorithms. Results are printed to the console and saved to 'WordCountResults.txt'.
